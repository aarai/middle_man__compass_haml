Because boilerplate, haml, ruby, and sass and compass are so awesome lets not create static sites without them. Middleman makes this super easy to build and deploy to any apache server. 
